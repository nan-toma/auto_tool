...
btnRead=tk.Button(root, height=1, width=10, text="実行", command=input_func)
btnRead.pack()
root.mainloop()
...
#ファイルを選択
driver.find_element_by_name("upfile").send_keys(up_folder_path + "\\" + "{}_fullconfig.zip".format(D_number))
